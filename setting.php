...
<div class="col-md-6">
          <div class="box box-default">
            ...
            <div class="box-body">
             ...
             <p class="cos"></p>   <!--reporting</p>-->
							<!--......-->
<form action="setting.php" method="POST" class="form-inline add_course_form">

     <button class="btn btn-primary course_form hiit_color add_btn"  type="submit"> <span class="lnr lnr-file-add"></span> Add  </button>
<input type="text"  class="form-control course_form" name="course"/>
